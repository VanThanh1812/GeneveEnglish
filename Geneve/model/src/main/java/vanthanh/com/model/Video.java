...
public class Video implements Serializable{
    ...
    public Video(String id, String title, String description, String thumbnail, String uploaded, String duration, String content, String rating, String viewCount, ArrayList<Comment> listcomment, String idCategory) {
        this.id = id;
        this.title = title;
